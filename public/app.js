...
const staticEnglishOverrides = {
  ...
  "公司配备数控切割机、自动焊接机、无损检测仪等先进设备，实现生产自动化、精细化。生产环节推行“三检制”（自检、互检、专检），每道工序操作人员自检、上下工序互检、质检专员专检，关键工序全程旁站监督。焊接工序执行无损检测，水压试验合格，确保设备耐压性与密封性；组装环节严格把控部件精度，杜绝错装、漏装。建立产品全生命周期追溯系统，从原材料批次、生产工序、操作人员到检测数据全程记录，实现质量问题可追溯、可追责。同时，定期开展设备维护校准与员工技能培训，保障生产稳定性，产品良品率稳定。": "The company uses CNC cutting machines, automatic welding machines, non-destructive testing instruments and other advanced equipment for automated, refined production. A three-level inspection system covers self-inspection, mutual inspection and dedicated inspection, with full supervision for key processes. Welds undergo non-destructive testing, hydrostatic tests are completed to verify pressure resistance and sealing, and assembly accuracy is controlled to prevent wrong or missing installation. A full lifecycle traceability system records raw material batches, production steps, operators and inspection data. Regular equipment calibration and staff training keep production stable and product quality consistent.",
