...
const labels = {
  zh: {
    ...
    "home.newsCopy": "保留公司动态与行业观察入口，首页只展示重点内容，完整新闻列表在新闻资讯页展开。",
    "profile.title": "公司简介",
  ...
  en: {
    ...
    "home.newsCopy": "Company updates and industry observations stay visible on the homepage, while the complete list opens on the news page.",
