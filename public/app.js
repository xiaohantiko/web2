...
const labels = {
  zh: {
    ...
    "products.dcmKicker": "氯代溶剂尾气",
    "products.dcmTitle": "二氯甲烷尾气回收系统",
    "products.dcmText": "二氯甲烷沸点低、挥发性强，适合采用分级冷凝、气液分离、干燥及吸附/吸收回收的组合路线，降低尾气中有机氯溶剂排放并回收可用溶剂。",
    "products.dcmProcess": "缓冲稳流、一级/二级冷凝、气液分离、回收塔再生、回收液暂存。",
    "products.dcmScene": "医药、精细化工、涂布及含二氯甲烷工艺尾气回收。",
    "products.cryoKicker": "低温冷凝回收",
    "products.cryoTitle": "冷冻冷凝回收装置",
    "products.cryoText": "通过多级冷冻换热把有机蒸气降至露点以下，使溶剂从尾气中冷凝析出，再经除雾、气液分离和冷凝液储存完成回收。",
    "products.cryoProcess": "一级/二级冷冻回收、循环冷媒、除雾捕集、气液分离、冷凝液回收。",
    "products.cryoScene": "中高浓度、具备回收价值且冷凝温度可达的 VOCs 尾气。",
  ...
  en: {
    ...
    "products.dcmKicker": "Chlorinated Solvent Exhaust",
    "products.dcmTitle": "Dichloromethane Tail-Gas Recovery System",
    "products.dcmText": "Dichloromethane has a low boiling point and high volatility, so staged condensation, gas-liquid separation, drying and adsorption or absorption recovery can reduce chlorinated solvent emissions while recovering usable solvent.",
    "products.dcmProcess": "Buffering, primary and secondary condensation, gas-liquid separation, recovery-column regeneration and recovered-liquid storage.",
    "products.dcmScene": "Pharmaceutical, fine chemical, coating and dichloromethane-containing exhaust recovery.",
    "products.cryoKicker": "Low-Temperature Condensation",
    "products.cryoTitle": "Cryogenic Condensation Recovery Unit",
    "products.cryoText": "Organic vapor is cooled below its dew point through staged heat exchange so solvents condense from the exhaust stream, then demisting, gas-liquid separation and condensate storage complete recovery.",
    "products.cryoProcess": "Primary and secondary cold recovery, circulating refrigerant, demisting, gas-liquid separation and condensate recovery.",
    "products.cryoScene": "Medium-to-high concentration VOC streams where the solvent has recovery value and reachable condensation temperature.",
